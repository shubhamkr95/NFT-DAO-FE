			...
			<div className="mx-auto max-w-2xl">
				...
				<div>
					<p className=" font-medium text-xl text-gray-400 mt-5">
						According to the specifications for Season 1, there are three seats open for the Grants Committee for the
						next term (Season 5 and Season 6).
					</p>
				</div>
				<div className=" mt-5  text-3xl font-bold text-gray-50">
				...
				<div>
					<p className=" font-medium text-xl text-gray-400 mt-5">
						Due to the limitation of characters that Snapshot imposes, it is not possible to have the full applications
						in this page.
					</p>
				</div>
				<div>
				...
				<div>
					<p className=" font-medium text-xl text-gray-400 mt-5">
						The voting system is weighted voting. You can distribute your vote to as many candidates as you wish and
						also choose the weight on it.
					</p>
				</div>
				<div>
					<p className=" font-medium text-xl text-gray-400 mt-5">
