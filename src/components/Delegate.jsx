  ...
  <div>
   <div className="mx-auto mt-10  text-white text-3xl font-bold max-w-2xl" id="delegate">
    ...
    <div className="border max-w-2xl mt-7 rounded-lg p-3" style={{ borderColor: "#2d2d2d" }}>
     <label
      htmlFor="email"
      className="block mt-3 mb-2 ml-0 md:ml-5 mr-3 mx-auto max-w-2xl text-sm font-medium text-gray-400 "
     >
      To
     </label>
     <input
     ...
     {!Loading ? (
      <button
       className="bg-transparent border  max-w-lg ml-0 md:ml-5 mr-3 mb-5 mt-4 mx-12 empty:3 px-12 py-1 rounded-full   font-medium text-gray-400 text-lg hover:bg-blue-600"
       style={{ borderColor: "#2d2d2d" }}
